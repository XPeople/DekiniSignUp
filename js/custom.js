...
jQuery(window).load(function(e) {
	...
	$('#slides').superslides({
    	...
    	animation: 'fade',
		pagination: false,
		inherit_width_from: $('#main-content'),
		inherit_height_from: $('#main-content')
    });
	...
	/*problem fix
	  in Chrome when superslides plugin changes one element with css3 animation became unstable, can't figure why, but remove css animation helps
	  make sure the animation reset is after animations run and before superslides changes
	*/
	var animation_reset = 2000;
	setTimeout(function(){$('.animated').removeClass('animated')},animation_reset);
	...
	var finish_date = '2016/10/21 12:00:00';	/* format YYYY/MM/DD hh:mm:ss */
